...
class Url(AbstractRule):
    ...
    def validate(self, input_val) -> bool:
        ...
        result = self._regex.match(input_val)
        return bool(result) and not any(
            (result.groupdict().get(key) for key in ('private_ip', 'private_host'))  # type: ignore
        )
